...
public class PlatformListPage extends PlatformListFakeActivity implements View.OnClickListener {
	...
	private void initPageView() {
		...
		FrameLayout.LayoutParams lpLl = new FrameLayout.LayoutParams(
				FrameLayout.LayoutParams.MATCH_PARENT, 660);
		...
		resId = getBitmapRes(getContext(), "iermu_click_selector");
		if(resId > 0){
		...
		LinearLayout.LayoutParams lpBtn = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.MATCH_PARENT, com.mob.tools.utils.R.dipToPx(getContext(), 48));
		int dp_10 = com.mob.tools.utils.R.dipToPx(getContext(), 10);
		int left = com.mob.tools.utils.R.dipToPx(getContext(), 30);
		int bottom = com.mob.tools.utils.R.dipToPx(getContext(), 60);
		lpBtn.setMargins(left, dp_10, left, bottom);
