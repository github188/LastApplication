 ...
 */
public class CloudOvertimeDialog extends Dialog implements View.OnClickListener {

    OnClickListener listener;

    protected CloudOvertimeDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
    }

    public CloudOvertimeDialog(Context context) {
    ...
    public interface OnClickListener {
        void onReturn(CloudOvertimeDialog view);

        void onPopBack(CloudOvertimeDialog view);
    }
