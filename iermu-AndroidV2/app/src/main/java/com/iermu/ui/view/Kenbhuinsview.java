...
public class Kenbhuinsview extends ImageView {
    ...
    /** A {@link Kenbhuinsview.TransitionListener} to be notified when
     *  a transition starts or ends. */
    private TransitionListener mTransitionListener;

    /** The ongoing transition. */
    private com.flaviofaria.kenburnsview.Transition mCurrentTrans;
    ...
    public Kenbhuinsview(Context context) {
        this(context, null);
    }


    public Kenbhuinsview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public Kenbhuinsview(Context context, AttributeSet attrs, int defStyle) {
...
//                    Logger.i(" currentRect.left:"+currentRect.left);
                    float translX = /*totalScale * */ (mDrawableRect.centerX() /*- Math.min(currentRect.left, (currentRect.width()/ 2) )*/);
     ...
     */
    private void fireTransitionStart(com.flaviofaria.kenburnsview.Transition transition) {
     ...
     */
    private void fireTransitionEnd(com.flaviofaria.kenburnsview.Transition transition) {
        if (mTransitionListener != null && transition != null) {
    ...
    public interface TransitionListener {
         ...
         * @param transition the transition that just started.
         */
        public void onTransitionStart(com.flaviofaria.kenburnsview.Transition transition);

        /**
         * Notifies the end of a transition.
         * @param transition the transition that just ended.
         */
        public void onTransitionEnd(com.flaviofaria.kenburnsview.Transition transition);
    }
}
