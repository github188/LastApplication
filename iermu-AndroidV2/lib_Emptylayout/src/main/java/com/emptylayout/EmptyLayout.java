...
public class EmptyLayout {
	...
	private int mLoadingViewButtonId = R.id.emptylayout_Loading_btn;
	private int mErrorViewButtonId = R.id.emptylayout_error_btn;
	private int mEmptyViewButtonId = R.id.emptylayout_empty_btn;
	...
	private void changeEmptyType() {
		...
		if (!mViewsAdded) {
			...
			if (mEmptyView!=null) rl.addView(mEmptyView, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
		...
		if (mListView!=null) {
			...
			case TYPE_EMPTY:
				...
				if (mErrorView!=null) mErrorView.setVisibility(View.GONE);
					if (mLoadingAnimation != null && mEmptyView!=null) {
						mEmptyView.startAnimation(mLoadingAnimation);
					}
					//else if (mEmptyView!=null) {
					//	mEmptyView.startAnimation(getRotateAnimation());
					//}
	...
	private void setDefaultValues() {
		if (mEmptyView==null) {
			mEmptyView = (ViewGroup) mInflater.inflate(R.layout.emptylayout_empty_view, null);
			if (!(mEmptyMessageViewId>0)) mEmptyMessageViewId = R.id.emptylayout_message_tv;
		...
		if (mLoadingView==null) {
			mLoadingView = (ViewGroup) mInflater.inflate(R.layout.emptylayout_loading_view, null);
			mLoadingAnimationViewId = R.id.emptylayout_loading;
			if (!(mLoadingMessageViewId>0)) mLoadingMessageViewId = R.id.emptylayout_message_tv;
		...
		if (mErrorView==null) {
			mErrorView = (ViewGroup) mInflater.inflate(R.layout.emptylayout_error_view, null);
			if (!(mErrorMessageViewId>0)) mErrorMessageViewId = R.id.emptylayout_message_tv;
