...
import com.iermu.analysis.db.MessageUtils;
import com.iermu.analysis.model.AIDLCacheEvent;
import com.iermu.analysis.model.EventType;
import com.iermu.analysis.model.PostEvent;
import com.iermu.analysis.server.RemoteService;
import com.iermu.analysis.util.CrashHandler;
import com.iermu.analysis.util.DeviceHelper;
import com.iermu.analysis.util.Ln;
import com.iermu.analysis.util.PreferencesHelper;
import com.iermu.analysis.server.AIDLService;
...
//		}
	...
	private static void isServiceConnect(Context context) {
		...
		if(context != null){
			...
			service.setAction("com.iermu.analysis.server.AIDLService");
