...
//            current.findViewById(R.id.description_layout).setVisibility(View.VISIBLE);
        }
    }
...
//            animator.start();
            if (listener != null) listener.updateBg(view);
        }
    }

    public interface UpdateDevBg{
        void updateBg(View view);
    }

    private UpdateDevBg listener;
    public void setListener(UpdateDevBg listener) {
