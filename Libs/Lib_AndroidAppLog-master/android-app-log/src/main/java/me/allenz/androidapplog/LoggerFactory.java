...
public class LoggerFactory {
	...
	public static TextView createLogTextView(final Activity activity) {
        ...
        final LogTextView textView = new LogTextView(activity);
        root.addView(textView);
        root.bringChildToFront(textView);
		return textView;
	}

    public static TextView createLogScrollTextView(final Activity activity) {
        final FrameLayout root = (FrameLayout) activity.getWindow()
                .getDecorView().findViewById(android.R.id.content);
        final LogScrollTextView textView = new LogScrollTextView(activity);
        root.addView(textView);
        root.bringChildToFront(textView);
        return textView;
    }
